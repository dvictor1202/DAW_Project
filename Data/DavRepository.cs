...
{
  public class DavRepository : IDavRepository
  {
    private readonly DavContext _ctx;
    private readonly ILogger<DavRepository> _logger;

    public DavRepository(DavContext ctx, ILogger<DavRepository> logger) 
    {
      _ctx = ctx;
      _logger = logger;
    }
